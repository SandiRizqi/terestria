...
class _LocationProviderScreenState extends State<LocationProviderScreen> {
  ...
  final TextEditingController _hostController =
      TextEditingController(text: '192.168.42.1');
  ...
  Future<void> _loadSavedSettings() async {
    ...
    final savedEmlidSettings =
        await _locationService.loadEmlidConnectionSettings();
    ...
    if (mounted) {
      setState(() {
        ...
        if (savedEmlidSettings['format'] != null) {
          ...
          if (formatIndex != null &&
              formatIndex < CoordinateFormat.values.length) {
            ...
            child: Column(
              ...
              children: [
                ...
                if (_selectedProvider == LocationProvider.emlid) ...[
                  ...
                  _buildSectionTitle(
                      'Emlid Connection', Icons.settings_ethernet),
